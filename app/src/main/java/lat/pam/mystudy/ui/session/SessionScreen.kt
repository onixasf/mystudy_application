...
import lat.pam.mystudy.ui.components.DeleteDialog
import lat.pam.mystudy.ui.components.SubjectListBottomSheet
import lat.pam.mystudy.ui.components.studySessionList
import lat.pam.mystudy.ui.theme.Red
import lat.pam.mystudy.util.Constant.ACTION_SERVICE_CANCEL
import lat.pam.mystudy.util.Constant.ACTION_SERVICE_START
import lat.pam.mystudy.util.Constant.ACTION_SERVICE_STOP
...
@Destination(
    deepLinks = [
        DeepLink(
            ...
            uriPattern = "my_study://dashboard/session"
        )
    ]
)
@Composable
...
private fun SessionScreen(
    ...
    DeleteDialog(
        ...
        bodyText = "Are you sure, you want to delete this session?. This action can't be undone.",
                ...
                ButtonSection(
                    ...
                    startButtonClick = {
                        if (state.subjectId != null && state.relatedToSubject != null){
                            ...
                            onEvent(SessionEvent.NotifiyToUpdateSubject)
                        }
                    },
                    cancelButtonClick = {
                        ServiceHelper.triggerForegroundService(
